package org.cy3fluxviz.io.image;
...
import cyfluxviz.util.file.FileUtils;
...
/**
 * Dialog to choose folder to export to.
 */
@SuppressWarnings("serial")
public class ExportAsGraphicsFolderChooser extends JDialog implements ActionListener{
	...
	public ExportAsGraphicsFolderChooser(final CyFileFilter[] formats, final CyFileFilter defaultFilter) {
		
		super(Cytoscape.getDesktop(), "Export CyFluxViz Network View as Graphics");
	...
	private void setDefaultFolderName() {
		...
		this.selectedFile = new File(recentDir.toString());
    ...
    public static void main(String[] args){
    	ExportAsGraphicsFolderChooser efc = new ExportAsGraphicsFolderChooser(GraphicsExporter.FILTERS,
    			GraphicsExporter.FILTERS[0]);
